System.register(["../enum/data-function.enum"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var data_function_enum_1, ChartUtils;
    return {
        setters: [
            function (data_function_enum_1_1) {
                data_function_enum_1 = data_function_enum_1_1;
            }
        ],
        execute: function () {
            ChartUtils = (function () {
            ...
            exports_1("ChartUtils", ChartUtils);
        }
    };
});
